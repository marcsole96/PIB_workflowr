...
avector <- c("1","2","1","2","1","2","1","2","2","3","4","5","6","1","1","1","1","1","1","2","2","2","3","3","3","4","4","4","5","5","5","6","6","6")

test<-training_DF %>% replace(1,c("1","2","1","2","1","2","1","2","2","3","4","5","6","1","1","1","1","1","1","2","2","2","3","3","3","4","4","4","5","5","5","6","6","6"))

head(select(test,1:5))
...
t_test_data<-t_test_data %>% replace(1,c("1","2","3","4","5","6"))
...
library(caret)
library(e1071)
pca = preProcess(x = simple_train_DF[-4502], method = "pca", pcaComp = 2)
training_set <- predict(pca, simple_train_DF)
