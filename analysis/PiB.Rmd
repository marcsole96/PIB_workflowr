...
We have 3 DFs containging training_data, each of them (despite having different regions analyzed) contain information on the squares which in turn can be used to identify the type of pen used. 
